...
interface TautanLayananItem {
  ...
  return (
    <section className="w-full relative">
      ...
      <div className="container mx-auto px-4 pt-6 md:pt-10 lg:pt-12 pb-12 md:pb-16 lg:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            <motion.h1 
              className="font-playfair text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-red-600 dark:text-red-400 leading-tight whitespace-nowrap"
