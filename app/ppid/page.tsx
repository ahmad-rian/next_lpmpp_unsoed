  ...
  return (
    <div className="w-full space-y-8 px-4 py-8">
      ...
      <div className="text-center mb-6 md:mb-16 space-y-3 md:space-y-4">
        ...
        <p className="text-sm md:text-base text-gray-500 dark:text-gray-500 max-w-2xl mx-auto px-4">
        ...
        <CardBody className="p-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-2">
              <DocumentIcon />
              <h2 className="text-xl font-semibold">Dokumen PPID</h2>
              <Chip size="sm" variant="flat">{filteredDocs.length}</Chip>
            </div>
            <Input
