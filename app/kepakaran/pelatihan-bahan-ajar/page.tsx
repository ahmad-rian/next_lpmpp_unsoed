...
export default function PelatihanBahanAjarPage() {
        ...
        <div className="w-full px-4 pb-12">
            ...
            <div className="text-center mb-8 md:mb-12 space-y-3">
                ...
                <p className="text-base md:text-xl text-default-600 max-w-3xl mx-auto">
                    Daftar fasilitator pelatihan bahan ajar LPMPP UNSOED
                </p>
            </div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-sm text-default-500">
                                                    Fasilitator Pelatihan Bahan Ajar
                                                </p>
                                            </div>
                        ...
                        <CardBody className="p-12 text-center">
                            ...
                            <p className="text-default-500">
                                {q
                                    ...
                                    : "Data fasilitator belum tersedia saat ini"}
                            </p>
                            {q && (
                                <button
                                    onClick={() => setQ("")}
