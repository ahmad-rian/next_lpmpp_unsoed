...
async function main() {
  ...
  if (allPermissions.length === 0) {
    ...
    const permissionsToCreate = [
      ...
      { name: "expertise.view", displayName: "View Supervisor", module: "expertise" },
      { name: "expertise.create", displayName: "Create Supervisor", module: "expertise" },
      { name: "expertise.update", displayName: "Update Supervisor", module: "expertise" },
      { name: "expertise.delete", displayName: "Delete Supervisor", module: "expertise" },
