...
const featuredPrograms = [
  ...
  },
  {
    ...
    description:
      ...
      '<p>Ketentuan lebih rinci tentang Buku Ajar dapat dilihat pada <em>Panduan Penulisan Buku Ilmiah Tahun 2023</em>, yang dapat diunduh pada menu Unduhan website LPMPP.</p>' +
      ...
      '<ul class="list-disc pl-5 space-y-1"><li>Buku ajar yang dapat diberikan insentif terbit paling lama TS-1 dari saat pengajuan.</li><li>Jika jumlah usulan melebihi kuota, akan diikutkan pada periode berikutnya. Kuota Tahun 2024 sebanyak <strong>20 judul</strong>.</li><li>Surat penugasan penulis/tim penulis dan penugasan penelaah isi/bahasa dapat dimintakan kepada Dekan masing-masing (tidak ada format baku).</li><li>LPMPP hanya memproses usulan terkait insentif Buku Ajar.</li></ul>',
    order: 2,
    isActive: true,
  },
  {
